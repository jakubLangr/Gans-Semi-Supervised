...
# will be convolved with images_re
        ...
        W_conv1 = tf.Variable(tf.truncated_normal([128,128,1,100],
                     stddev=0.1,
...
# Conv layer
    with tf.name_scope('Conv2'):
        W_conv2 = tf.Variable(tf.truncated_normal([64,64,100,200],
                     stddev=0.1,
...
# Conv layer
    with tf.name_scope('Conv3'):
        W_conv3 = tf.Variable(tf.truncated_normal([32,32,200,300],
                     stddev=0.1,
...
# Conv layer
    with tf.name_scope('Conv4'):
        W_conv4 = tf.Variable(tf.truncated_normal([32,32,300,300],
                    stddev=0.1,
